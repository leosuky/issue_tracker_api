...
class PublicUserApiTests(TestCase):
    """Test public(unauthenticated) features of the user API"""
    ...
    def test_password_too_short_error(self):
        """Test that an error occurs if password is less than 5 characters"""
        payload = {
            'email': 'test@example.com',
            'password': 'red',
            'name': 'Test Name',
    ...
    def test_retrieve_user_unauthorized(self):
        """Test authentication is required to retrieve user info"""
